...
# Average CV score on the training set was:-0.17528071483901106
exported_pipeline = make_pipeline(
    ...
    Normalizer(norm="l1"),
    StackingEstimator(estimator=LinearSVR(C=0.1, dual=False, epsilon=1.0, loss="squared_epsilon_insensitive", tol=0.01)),
