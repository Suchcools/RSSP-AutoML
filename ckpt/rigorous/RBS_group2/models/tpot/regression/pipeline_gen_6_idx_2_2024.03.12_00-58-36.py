...
# Average CV score on the training set was:-0.2050742897397543
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LinearSVR(C=20.0, dual=True, epsilon=1.0, loss="epsilon_insensitive", tol=0.001)),
