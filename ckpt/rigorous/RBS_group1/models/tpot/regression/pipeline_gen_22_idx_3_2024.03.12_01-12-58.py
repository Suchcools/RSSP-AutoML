...
# Average CV score on the training set was:-0.17588051279717298
exported_pipeline = make_pipeline(
    ...
    RandomForestRegressor(bootstrap=True, max_features=0.35000000000000003, min_samples_leaf=8, min_samples_split=6, n_estimators=100)
)
